...
/// <summary>
/// T4 — the generated <c>AgwfCode</c> C# enum. Asserts it has exactly 39
...
public sealed class AgwfCodeEnumTests
{
    ...
    [
        ...
        ("BoundWorkflowNotFound", "AGWF039"),
        ("WorkflowActionReferenceInvalid", "AGWF040"),
        ("WorkflowBindingRefinementFailed", "AGWF041"),
        ("WorkflowContractUnprovable", "AGWF042"),
        ("WorkflowEmissionIdentityCollision", "AGWF043"),
        ("AuthoredInverseDisagrees", "AGWF044"),
        ("CompensationScopeNotDerivable", "AGWF045"),
    ];
    ...
    public async Task AgwfCodeEnum_AllMembers_RoundTripsWireValues()
    {
        ...
        await Assert.That(members.Length).IsEqualTo(Expected.Length)
            .Because("AgwfCode must have exactly 39 members.");
