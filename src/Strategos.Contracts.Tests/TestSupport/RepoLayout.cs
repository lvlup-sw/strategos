...
/// root (the directory containing <c>strategos.slnx</c>).
/// </summary>
internal static class RepoLayout
{
    /// <summary>Gets the repository root (the directory containing <c>strategos.slnx</c>).</summary>
    ...
    private static string FindRepoRoot()
    {
        ...
        throw new InvalidOperationException(
            "Could not locate repo root (no strategos.slnx found walking up from "
