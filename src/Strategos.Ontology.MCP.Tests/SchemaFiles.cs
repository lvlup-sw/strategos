...
/// <c>strategos.slnx</c>). Schemas are loaded as FILES so the ontology test suite
...
internal static class SchemaFiles
{
    ...
    private static string Resolve()
    {
        ...
        throw new InvalidOperationException(
            "Could not locate repo root (no strategos.slnx) walking up from " + AppContext.BaseDirectory + ".");
    }
}
