...
export const ActionRequirementStrengthV1Schema = z.enum(["hard", "soft"]);

export type ActionRequirementStrengthV1 = z.infer<typeof ActionRequirementStrengthV1Schema>;
