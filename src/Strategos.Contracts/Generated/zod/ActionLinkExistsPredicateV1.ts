...
export const ActionLinkExistsPredicateV1Schema = z.looseObject({
    "kind": z.literal("link-exists"),
    "linkName": z.string().min(1),
  });

export type ActionLinkExistsPredicateV1 = z.infer<typeof ActionLinkExistsPredicateV1Schema>;
