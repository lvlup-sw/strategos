...
export const InvariantWorkflowSchema = z.enum(["feature", "debug", "refactor", "discovery", "oneshot"]);

export type InvariantWorkflow = z.infer<typeof InvariantWorkflowSchema>;
