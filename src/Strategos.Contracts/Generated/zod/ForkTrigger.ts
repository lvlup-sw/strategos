...
export const ForkTriggerSchema = z.enum(["ratification_failure", "gate_contradiction", "operator_explicit"]);

export type ForkTrigger = z.infer<typeof ForkTriggerSchema>;
