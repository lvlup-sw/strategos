...
public sealed class CoverageAttributeStampingTests
{
    ...
    {
        var generatorDir = Path.Combine(FindRepoRoot(), "src", "Strategos.Generators");
    ...
    // Walks up to the repository root (the directory containing strategos.slnx). Call sites name
    // the tree they want, because src/ holds product projects and tests/ holds test projects.
