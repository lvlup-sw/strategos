...
| AONT216 | Error | Compensation disagrees with derived inverse | The named compensator is missing or its frame differs from the forward action. | Declare the compensator and give it exactly the forward action's frame. | 2.13.0 |
