...
| AONT216 | Error | Compensation disagrees with derived inverse | The named compensator is missing, unprovable, or differs from the derived inverse in its requirement, guarantee, frame, or semantic authority. | Declare one closed same-subject compensator whose requirement is equivalent to the forward effective guarantee, whose effective guarantee restores the forward hard requirement, and whose frame and authority are equal. | 2.13.0 |
