...
| [Typed action calculus](/reference/action-calculus) | Immutable predicates, post-state guarantees, exact sequential proofs, tri-state enforcement, authority, and frames |
